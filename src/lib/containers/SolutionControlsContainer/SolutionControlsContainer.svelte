<script lang="ts">
    ...
    import { TheoremParser } from "../../solver/parsers/TheoremParser";
    ...
    import { setupProof } from "../../solver/utils/proofUtils";
    import { checkProof, resetSolving } from "../../solver/actions/proofActions";
